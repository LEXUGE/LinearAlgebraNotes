...
\section{Chapter 1}
\label{sec:org2f661dc}
\subsection{\(\S\) 1}
\label{sec:orgef96fe8}
\subsubsection{Notes}
\label{sec:org603bd94}
...
Refer to the \hyperref[org1b2f0e2]{note part} for proof for \(U+W\).
\item \textbf{Exercise 11}
\label{sec:org35d635f}
...
\label{sec:orgc4dbb45}
Same technique as Exercise 12.
\item \textbf{Exercise 14}
\label{sec:org1ad49c7}
Same technique as Exercise 12.
\end{enumerate}
\subsection{\(\S\) 2}
\label{sec:org7e93a7b}
\subsubsection{Notes}
\label{sec:org5c85809}
\label{org5165404}
...
\subsubsection{Exercises}
\label{sec:orgdda758c}
\begin{enumerate}
\item \textbf{Exercise 1}
\label{sec:org7367494}
Using result from \hyperref[org0f48306]{\textbf{Exercise 4}}, easy to prove.
\item \textbf{Exercise 2}
\label{sec:orge4f974d}
\begin{enumerate}
\item \((1,-1)\)
\label{sec:org4ebbe1c}
\item \((\frac{1}{2},\frac{3}{2})\)
\label{sec:orgde8f299}
\item \((1,1)\)
\label{sec:orge8fed3c}
\item \((3,2)\)
\label{sec:orgbb95783}
\end{enumerate}
\item \textbf{Exercise 3}
\label{sec:orgaf94d54}
\begin{enumerate}
\item \((\frac{1}{3},-\frac{1}{3},\frac{1}{3})\)
\label{sec:org53a49dd}
\item \((1,0,1)\)
\label{sec:org4cb9723}
\item \((\frac{1}{3},-\frac{1}{3},-\frac{2}{3})\)
\label{sec:orgd96ed26}
\end{enumerate}
\item \textbf{Exercise 4}
\label{sec:org6d96d58}
\label{org0f48306}
...
\item \textbf{Exercise 7}
\label{sec:orgbc6fe88}
\((3,5)\)
\item \textbf{Exercise 8}
\label{sec:org64f2fa0}
\emph{\textbf{Calculus involved, not doing now.}}
\item \textbf{Exercise 9}
\label{sec:org21b2980}
$$\begin{aligned}
...
\subsection{\(\S\) 4}
\label{sec:org17a14ec}
\subsubsection{Notes}
\label{sec:org3c3043a}
...
\subsubsection{Exercises}
\label{sec:org8cc54bb}
\begin{enumerate}
\item \textbf{Exercise 1}
\label{sec:org54d437a}
...
\item \textbf{Exercise 3}
\label{sec:orgbca9a5e}
According to argument provided \hyperref[org5165404]{here}, \(\forall c\in K,cA\not =B\) means that \(A,B\) are linear independent. Also, according to \textbf{Theorem 3.4}, they are a basis of \(\mathbb{R}^2\).\\
Based on the similar argument in \textbf{Exercise 1}, second part could be proved.
\item \textbf{Exercise 4}
\label{sec:org336d811}
See notes
\end{enumerate}
\section{Chapter 2}
\label{sec:org9f0688b}
\subsection{\(\S\) 1}
\label{sec:orgc5081c9}
\subsubsection{Exercises}
\label{sec:org808d442}
\begin{enumerate}
\item \textbf{Exercise 1}
\label{sec:org77f4e17}
Skip
\item \textbf{Exercise 2}
\label{sec:org522d05e}
Skip
\item \textbf{Exercise 3}
\label{sec:org1430e7c}
Skip
\item \textbf{Exercise 4}
\label{sec:orga4bab78}
Skip
\item \textbf{Exercise 5}
\label{sec:org6d28636}
Let \(C=^t(A+B)=(c_{ij})\). Then, \(c_{ij}=(a_{ij}+b_{ij})'=a_{ji}+b_{ji}\). Thus, \(C=^tA+^tB\).
\item \textbf{Exercise 6}
\label{sec:org0b53450}
Let \(B=^t(cA)\). Then, \(b_{ij}=ca_{ji}\). Since \(^tA=(a^{\prime}_{ij})=(a_{ji})=A\), \(B=c^tA\).
\item \textbf{Exercise 7}
\label{sec:orgfca44f4}
No difference.
\item \textbf{Exercise 8}
\label{sec:orgab25d17}
Skip
\item \textbf{Exercise 9}
\label{sec:orgcf2c57f}
Skip
\item \textbf{Exercise 10}
\label{sec:org533dfc4}
Let \(B=A+^tA=(b_{ij})=(a_{ij}+a_{ji})\). Since, \(b_{ij}=a_{ij}+a_{ji}=a_{ji}+b_{ij}=b_{ji}\), \(B\) is symmetric.
\item \textbf{Exercise 11}
\label{sec:org24176d6}
Skip
\item \textbf{Exercise 12}
\label{sec:org935ee3c}
Skip
\item \textbf{Exercise 13}
\label{sec:orgebeebbb}
...
\end{enumerate}
\subsection{\(\S\) 3}
\label{sec:org85bd4e6}
\subsubsection{Exercises}
\label{sec:org2af7b81}
\begin{enumerate}
\item \textbf{Exercise 1}
\label{sec:orgb21dc25}
\(AI=IA=A\)
\item \textbf{Exercise 2}
\label{sec:orga339798}
\(AO=O\)
\item \textbf{Exercise 3}
\label{sec:org3d7c03e}

For every \(A\) and \(B\), \((AB)C=A(BC)\).
\begin{enumerate}
\item Case 1
\label{sec:org9181c80}
$$\begin{pmatrix}
3&2\\
4&1
\end{pmatrix}$$
\item Case 2
\label{sec:orgd59c006}
$$\begin{pmatrix}
10\\
14
\end{pmatrix}$$
\item Case 3
\label{sec:org109756b}
$$\begin{pmatrix}
33&37\\
11&-18
\end{pmatrix}$$
\end{enumerate}
\item \textbf{Exercise 4}
\label{sec:orgbbc06b9}
This one could be proved as it is proved \hyperref[org8a90317]{here}.
\item \textbf{Exercise 5}
\label{sec:orge4ad4da}
$$AB=\begin{pmatrix}
4&2\\
5&-1
\end{pmatrix}$$
...
\item \textbf{Exercise 7}
\label{sec:orgf9d6436}
$$XA=\begin{pmatrix}
3&1&5
\end{pmatrix}$$
\item \textbf{Exercise 8}
\label{sec:org4b2c664}
$$\begin{aligned}
X_1 A=A_2\\
X_2 A=A_3
\end{aligned}$$
...
\end{pmatrix}$$
\item \textbf{Exercise 15}
\label{sec:org3187940}
\(AX=A^2\) (second column of \(A\)).
\item \textbf{Exercise 16}
\label{sec:org1643cff}
\(AX=A^i\)
\item \textbf{Exercise 17}
\label{sec:org59de92e}
...
\label{sec:org6ba62ce}
\item Set \(A^{-1}=(-A-2I)\)
\label{sec:org1c786ca}
\item Set \(A^{-1}=(-A^2-A)\)
\label{sec:orgaa1b122}
\end{enumerate}
\item \textbf{Exercise 19}
\label{sec:org862285f}
$$AB=\begin{pmatrix}
1 & ab\\
0 & 1
\end{pmatrix}$$
...
\item \textbf{Exercise 20}
\label{sec:org8e8395e}
$$A^{-1}=\begin{pmatrix}
1 & -a \\
0 & 1
\end{pmatrix}$$
\item \textbf{Exercise 21}
\label{sec:orge9bbf5d}
...
\label{sec:orged2df53}
$$A=\begin{pmatrix}
0 & 1\\
-1 & 0
\end{pmatrix}$$
\item \textbf{Exercise 25}
\label{sec:orgf1ca883}
\begin{enumerate}
\item \(\text{tr}(A)=2\)
\label{sec:org545a397}
\item \(\text{tr}(A)=4\)
\label{sec:orgaed1067}
\item \(\text{tr}(A)=8\)
\label{sec:orgd782870}
\end{enumerate}
\item \textbf{Exercise 26}
\label{sec:org3c8862a}
See \textbf{Exercise 27}.
\item \textbf{Exercise 27}
\label{sec:org54b62e5}
$$\begin{aligned}
...
\subsubsection{Exercises}
\label{sec:orgf70286c}
\begin{enumerate}
\item \textbf{Exercise 1}
\label{sec:orgf723654}
\emph{\textbf{Calculus involved, not doing now.}}
\item \textbf{Exercise 2}
\label{sec:org80cdf5d}
Proved in notes.
\item \textbf{Exercise 3}
\label{sec:org552fa3c}
\begin{enumerate}
\item \(L(X)=11\)
\label{sec:org142894b}
\item \(L(X)=13\)
\label{sec:org5534277}
\item \(L(X)=6\)
\label{sec:orged9e4f4}
\end{enumerate}
\item \textbf{Exercise 4}
\label{sec:org541d6a2}

\(F(1)=(e,1)\), \(F(0)=(1,0)\), \(F(-1)=(e^{-1},-1)\)
\item \textbf{Exercise 5}
\label{sec:org3ab4bdf}

\((F+G)(1)=(e+1,3)\), \((F+G)(2)=(e^2+2,6)\), \((F+G)(0)=(1,0)\)
\item \textbf{Exercise 6}
\label{sec:org77b9885}

\((2F)(0)=(2,0)\), \((\pi F)(1)=(\pi e,\pi)\)
\item \textbf{Exercise 7}
\label{sec:org460c946}
For (a), it is 1. For (b), it is 11.
\item \textbf{Exercise 8}
\label{sec:org3b24c86}

The image is a ellipse of the equation
$$\frac{u^2}{4}+\frac{w^2}{9}=1$$
Proof is omitted.
\item \textbf{Exercise 9}
\label{sec:orgefa4953}
