...
Refer to the \hyperref[org72f045b]{note part} for proof for \(U+W\).
\item \textbf{Exercise 11}
\label{sec:org2cf4917}
...
\label{sec:org69c1822}
Same technique as Exercise 12.
\item \textbf{Exercise 14}
\label{sec:org3afcb70}
Same technique as Exercise 12.
\end{enumerate}
\subsection{\(\S\) 2}
\label{sec:orgf561e40}
\subsubsection{Exercises}
