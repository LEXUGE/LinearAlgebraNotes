...
\section{Chapter 1}
\label{sec:orgf1e48e3}
\subsection{\(\S\) 1}
\label{sec:orga8c254e}
\subsubsection{Notes}
\label{sec:org36915c6}
...
Refer to the \hyperref[orgbb25052]{note part} for proof for \(U+W\).
\item \textbf{Exercise 11}
\label{sec:org03a2e49}
...
\label{sec:org519a5b5}
Same technique as Exercise 12.
\item \textbf{Exercise 14}
\label{sec:orgbea924e}
Same technique as Exercise 12.
\end{enumerate}
\subsection{\(\S\) 2}
\label{sec:org2a259d6}
\subsubsection{Notes}
\label{sec:orgcde85bf}
\label{org8baa3fd}
...
\subsubsection{Exercises}
\label{sec:org9e17189}
\begin{enumerate}
\item \textbf{Exercise 1}
\label{sec:orgb2b5a8b}
Using result from \hyperref[org023232a]{\textbf{Exercise 4}}, easy to prove.
\item \textbf{Exercise 2}
\label{sec:org2dbf827}
\begin{enumerate}
\item \((1,-1)\)
\label{sec:orgf46329e}
\item \((\frac{1}{2},\frac{3}{2})\)
\label{sec:org4735997}
\item \((1,1)\)
\label{sec:org16b0ee6}
\item \((3,2)\)
\label{sec:org95585cb}
\end{enumerate}
\item \textbf{Exercise 3}
\label{sec:org6fea0a5}
\begin{enumerate}
\item \((\frac{1}{3},-\frac{1}{3},\frac{1}{3})\)
\label{sec:org565f82f}
\item \((1,0,1)\)
\label{sec:org9205270}
\item \((\frac{1}{3},-\frac{1}{3},-\frac{2}{3})\)
\label{sec:org43caa30}
\end{enumerate}
\item \textbf{Exercise 4}
\label{sec:orgb09f960}
\label{org023232a}
...
\item \textbf{Exercise 7}
\label{sec:org435645d}
\((3,5)\)
\item \textbf{Exercise 8}
\label{sec:org256a5a6}
\emph{\textbf{Calculus involved, not doing now.}}
\item \textbf{Exercise 9}
\label{sec:org7c1a060}
$$\begin{aligned}
...
\subsection{\(\S\) 4}
\label{sec:org00c714d}
\subsubsection{Notes}
\label{sec:orgcd748b6}
