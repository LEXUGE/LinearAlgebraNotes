...
\section{Chapter 1}
\label{sec:orgf2e74a8}
\subsection{\(\S\) 1}
\label{sec:orge295bc8}
\subsubsection{Notes}
\label{sec:orgdc1d6b8}
...
Refer to the \hyperref[org85de33c]{note part} for proof for \(U+W\).
\item \textbf{Exercise 11}
\label{sec:org3a7bee7}
...
\label{sec:org635f6b8}
Same technique as Exercise 12.
\item \textbf{Exercise 14}
\label{sec:org5be232e}
Same technique as Exercise 12.
\end{enumerate}
\subsection{\(\S\) 2}
\label{sec:org98b9de7}
\subsubsection{Notes}
...
\subsubsection{Exercises}
\label{sec:org3700ffa}
\begin{enumerate}
\item \textbf{Exercise 1}
\label{sec:org8dd9f73}
Using result from \hyperref[org0fd46de]{\textbf{Exercise 4}}, easy to prove.
\item \textbf{Exercise 2}
\label{sec:org05b0564}
\begin{enumerate}
\item \((1,-1)\)
\label{sec:orgc25c944}
\item \((\frac{1}{2},\frac{3}{2})\)
\label{sec:org5764822}
\item \((1,1)\)
\label{sec:org2fdea08}
\item \((3,2)\)
\label{sec:org6878334}
\end{enumerate}
\item \textbf{Exercise 3}
\label{sec:org761871a}
\begin{enumerate}
\item \((\frac{1}{3},-\frac{1}{3},\frac{1}{3})\)
\label{sec:org55332ce}
\item \((1,0,1)\)
\label{sec:org0e22c06}
\item \((\frac{1}{3},-\frac{1}{3},-\frac{2}{3})\)
\label{sec:org9c702e5}
\end{enumerate}
\item \textbf{Exercise 4}
\label{sec:org529bd82}
\label{org0fd46de}
...
\item \textbf{Exercise 7}
\label{sec:org7413c47}
\((3,5)\)
\item \textbf{Exercise 8}
\label{sec:org8c69f0f}
\emph{\textbf{Calculus involved, not doing now.}}
\item \textbf{Exercise 9}
\label{sec:org07706a6}
$$\begin{aligned}
...
\subsection{\(\S\) 4}
\label{sec:org6b50779}
\subsubsection{Notes}
\label{sec:orgb7b4115}
...
\subsubsection{Exercises}
\label{sec:org57607af}
\begin{enumerate}
\item \textbf{Exercise 1}
\label{sec:orgbab44c2}
...
According to argument provided \hyperref[orgb6c34b8]{here}, \(A,B\) are linear independent. Also, according to \textbf{Theorem 3.4}, they are a basis of \(\mathbb{R}^2\).\\
Based on the similar argument in \textbf{Exercise 1}, second part could be proved.
\item \textbf{Exercise 4}
\label{sec:orgfc588bf}
See notes
\end{enumerate}
\section{Chapter 2}
\label{sec:org3d234b7}
\subsection{\(\S\) 1}
\label{sec:orgcf7c42c}
\subsubsection{Exercises}
\label{sec:org497f6b8}
\begin{enumerate}
\item \textbf{Exercise 1}
\label{sec:org6f9bcf4}
Skip
\item \textbf{Exercise 2}
\label{sec:org0c3766d}
Skip
\item \textbf{Exercise 3}
\label{sec:org3885ae4}
Skip
\item \textbf{Exercise 4}
\label{sec:org22b2d81}
Skip
\item \textbf{Exercise 5}
\label{sec:orgd067eda}
Let \(C=^t(A+B)=(c_{ij})\). Then, \(c_{ij}=(a_{ij}+b_{ij})'=a_{ji}+b_{ji}\). Thus, \(C=^tA+^tB\).
\item \textbf{Exercise 6}
\label{sec:orga0963e9}
Let \(B=^t(cA)\). Then, \(b_{ij}=ca_{ji}\). Since \(^tA=(a^{\prime}_{ij})=(a_{ji})=A\), \(B=c^tA\).
\item \textbf{Exercise 7}
\label{sec:org0dfe9d5}
No difference.
\item \textbf{Exercise 8}
\label{sec:org4090bd8}
Skip
\item \textbf{Exercise 9}
\label{sec:org34b8235}
Skip
\item \textbf{Exercise 10}
\label{sec:orgb92fbb9}
Let \(B=A+^tA=(b_{ij})=(a_{ij}+a_{ji})\). Since, \(b_{ij}=a_{ij}+a_{ji}=a_{ji}+b_{ij}=b_{ji}\), \(B\) is symmetric.
\item \textbf{Exercise 11}
\label{sec:orga7757da}
Skip
\item \textbf{Exercise 12}
\label{sec:org20d3597}
Skip
\item \textbf{Exercise 13}
\label{sec:org4d7ae20}
...
\end{enumerate}
\subsection{\(\S\) 3}
\label{sec:orgaa1f70e}
\subsubsection{Exercises}
\label{sec:orgeafc419}
\begin{enumerate}
\item \textbf{Exercise 1}
\label{sec:org586ac64}
\(AI=IA=A\)
\item \textbf{Exercise 2}
\label{sec:orgb07b12b}
\(AO=O\)
\item \textbf{Exercise 3}
\label{sec:org298815c}

For every \(A\) and \(B\), \((AB)C=A(BC)\).
\begin{enumerate}
\item Case 1
\label{sec:org2cd5d2c}
$$\begin{pmatrix}
3&2\\
4&1
\end{pmatrix}$$
\item Case 2
\label{sec:orgdc8fd7a}
$$\begin{pmatrix}
10\\
14
\end{pmatrix}$$
\item Case 3
\label{sec:org01e0dac}
$$\begin{pmatrix}
33&37\\
11&-18
\end{pmatrix}$$
\end{enumerate}
\item \textbf{Exercise 4}
\label{sec:org8acf746}
This one could be proved as it is proved \hyperref[org581f974]{here}.
\item \textbf{Exercise 5}
\label{sec:orgd8ff319}
$$AB=\begin{pmatrix}
4&2\\
5&-1
\end{pmatrix}$$
...
\item \textbf{Exercise 7}
\label{sec:org5be1a79}
$$XA=\begin{pmatrix}
3&1&5
\end{pmatrix}$$
\item \textbf{Exercise 8}
\label{sec:orgdfe1e32}
$$\begin{aligned}
X_1 A=A_2\\
X_2 A=A_3
\end{aligned}$$
...
\end{pmatrix}$$
\item \textbf{Exercise 15}
\label{sec:orgaa8cc7d}
\(AX=A^2\) (second column of \(A\)).
\item \textbf{Exercise 16}
\label{sec:orgcd4c81b}
\(AX=A^i\)
\item \textbf{Exercise 17}
\label{sec:org49c0ee0}
...
\label{sec:orgde4ee00}
\item Set \(A^{-1}=(-A-2I)\)
\label{sec:orgfa0256b}
\item Set \(A^{-1}=(-A^2-A)\)
\label{sec:orgbada3b9}
\end{enumerate}
\item \textbf{Exercise 19}
\label{sec:orgef9dcc8}
$$AB=\begin{pmatrix}
1 & ab\\
0 & 1
\end{pmatrix}$$
...
\item \textbf{Exercise 20}
\label{sec:org860b0e0}
$$A^{-1}=\begin{pmatrix}
1 & -a \\
0 & 1
\end{pmatrix}$$
\item \textbf{Exercise 21}
\label{sec:org001729f}
...
\label{sec:orga8d31c8}
$$A=\begin{pmatrix}
0 & 1\\
-1 & 0
\end{pmatrix}$$
\item \textbf{Exercise 25}
\label{sec:orga5d712a}
\begin{enumerate}
\item \(\text{tr}(A)=2\)
\label{sec:org6ae8a58}
\item \(\text{tr}(A)=4\)
\label{sec:orgafb8fe5}
\item \(\text{tr}(A)=8\)
\label{sec:orgba46d79}
\end{enumerate}
\item \textbf{Exercise 26}
\label{sec:org31f0762}
See \textbf{Exercise 27}.
\item \textbf{Exercise 27}
\label{sec:org8475578}
$$\begin{aligned}
...
\end{enumerate}
\section{Chapter 3}
\label{sec:org2240326}
\subsection{\(\S\) 1}
\label{sec:orgd081899}
\subsubsection{Notes}
\label{sec:org074b445}
...
\subsubsection{Exercises}
\label{sec:orgaf0ec95}
\begin{enumerate}
\item \textbf{Exercise 1}
\label{sec:org056d20c}
\emph{\textbf{Calculus involved, not doing now.}}
\item \textbf{Exercise 2}
\label{sec:orgae88dfc}
Proved in notes.
\item \textbf{Exercise 3}
\label{sec:org3091171}
\begin{enumerate}
\item \(L(X)=11\)
\label{sec:orgfea5632}
\item \(L(X)=13\)
\label{sec:orgeb2d91e}
\item \(L(X)=6\)
\label{sec:org3645526}
\end{enumerate}
\item \textbf{Exercise 4}
\label{sec:orgce9a8ea}

\(F(1)=(e,1)\), \(F(0)=(1,0)\), \(F(-1)=(e^{-1},-1)\)
\item \textbf{Exercise 5}
\label{sec:org751fc2a}

\((F+G)(1)=(e+1,3)\), \((F+G)(2)=(e^2+2,6)\), \((F+G)(0)=(1,0)\)
\item \textbf{Exercise 6}
\label{sec:org4be0d1a}

\((2F)(0)=(2,0)\), \((\pi F)(1)=(\pi e,\pi)\)
\item \textbf{Exercise 7}
\label{sec:orgab95666}
For (a), it is 1. For (b), it is 11.
\item \textbf{Exercise 8}
\label{sec:org507b494}

The image is a ellipse of the equation
$$\frac{u^2}{4}+\frac{w^2}{9}=1$$
Proof is omitted.
\item \textbf{Exercise 9}
\label{sec:org67f6a5f}
...
\item \textbf{Exercise 10}
\label{sec:orgf555ad8}
By definition, it is a parallelogram.
\item \textbf{Exercise 11}
\label{sec:org0139100}
...
\item \textbf{Exercise 13}
\label{sec:org3462250}
It is a parallelogram generated by \(5A\) and \(2B\).
\item \textbf{Exercise 14}
\label{sec:orge5d4524}
\(T_u(v_1+v_2)=v_1+v_2+u=T_u(v_1)+T_u(v_2)=v_1+v_2+2u\). Thus, we have \(2u=u\) and \(u=O\).
\item \textbf{Exercise 15}
\label{sec:orgf04744c}
It is shown in \hyperref[org8cb922a]{Lemma}.
\item \textbf{Exercise 16}
\label{sec:orga22b8d3}
