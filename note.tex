...
\section{Chapter 1}
\label{sec:org5f8c0ff}
\subsection{\(\S\) 1}
\label{sec:org6731ca6}
\subsubsection{Notes}
\label{sec:org4da2382}
...
Refer to the \hyperref[org17c59f8]{note part} for proof for \(U+W\).
\item \textbf{Exercise 11}
\label{sec:org85a89f1}
...
\label{sec:org457ac99}
Same technique as Exercise 12.
\item \textbf{Exercise 14}
\label{sec:orgc27e61a}
Same technique as Exercise 12.
\end{enumerate}
\subsection{\(\S\) 2}
\label{sec:org3a45366}
\subsubsection{Notes}
\label{sec:orgbec6ed6}
\label{orgb87d0ec}
...
\subsubsection{Exercises}
\label{sec:org775156d}
\begin{enumerate}
\item \textbf{Exercise 1}
\label{sec:org359df77}
Using result from \hyperref[org73c3ebf]{\textbf{Exercise 4}}, easy to prove.
\item \textbf{Exercise 2}
\label{sec:orgbe5b2aa}
\begin{enumerate}
\item \((1,-1)\)
\label{sec:org083ac64}
\item \((\frac{1}{2},\frac{3}{2})\)
\label{sec:org92e96f7}
\item \((1,1)\)
\label{sec:orgf2c91e1}
\item \((3,2)\)
\label{sec:org408a5d5}
\end{enumerate}
\item \textbf{Exercise 3}
\label{sec:orga5aef06}
\begin{enumerate}
\item \((\frac{1}{3},-\frac{1}{3},\frac{1}{3})\)
\label{sec:orga3adfec}
\item \((1,0,1)\)
\label{sec:org9ddb465}
\item \((\frac{1}{3},-\frac{1}{3},-\frac{2}{3})\)
\label{sec:org66bc2c4}
\end{enumerate}
\item \textbf{Exercise 4}
\label{sec:org2b470d1}
\label{org73c3ebf}
...
\item \textbf{Exercise 7}
\label{sec:orgb2ba8cc}
\((3,5)\)
\item \textbf{Exercise 8}
\label{sec:org19eb236}
\emph{\textbf{Calculus involved, not doing now.}}
\item \textbf{Exercise 9}
\label{sec:org9756f1f}
$$\begin{aligned}
...
\subsection{\(\S\) 4}
\label{sec:orga1262b4}
\subsubsection{Notes}
\label{sec:orgdd1a319}
...
\subsubsection{Exercises}
\label{sec:org662dd82}
\begin{enumerate}
\item \textbf{Exercise 1}
\label{sec:org68c9c8d}
...
\item \textbf{Exercise 3}
\label{sec:orgf6b63da}
According to argument provided \hyperref[orgb87d0ec]{here}, \(\forall c\in K,cA\not =B\) means that \(A,B\) are linear independent. Also, according to \textbf{Theorem 3.4}, they are a basis of \(\mathbb{R}^2\).\\
Based on the similar argument in \textbf{Exercise 1}, second part could be proved.
\item \textbf{Exercise 4}
\label{sec:orgb161f94}
See notes
\end{enumerate}
\section{Chapter 2}
\label{sec:org1b8a8e6}
\subsection{\(\S\) 1}
\label{sec:org8028ffa}
\subsubsection{Exercises}
\label{sec:org425f46d}
\begin{enumerate}
\item \textbf{Exercise 1}
\label{sec:orgc837166}
Skip
\item \textbf{Exercise 2}
\label{sec:orge7665b7}
Skip
\item \textbf{Exercise 3}
\label{sec:org3186c39}
Skip
\item \textbf{Exercise 4}
\label{sec:org4fa4838}
Skip
\item \textbf{Exercise 5}
\label{sec:org03864a1}
Let \(C=^t(A+B)=(c_{ij})\). Then, \(c_{ij}=(a_{ij}+b_{ij})'=a_{ji}+b_{ji}\). Thus, \(C=^tA+^tB\).
\item \textbf{Exercise 6}
\label{sec:orgc47708d}
Let \(B=^t(cA)\). Then, \(b_{ij}=ca_{ji}\). Since \(^tA=(a^{\prime}_{ij})=(a_{ji})=A\), \(B=c^tA\).
\item \textbf{Exercise 7}
\label{sec:orgabe6373}
No difference.
\item \textbf{Exercise 8}
\label{sec:org501c7cb}
Skip
\item \textbf{Exercise 9}
\label{sec:org625f8a6}
Skip
\item \textbf{Exercise 10}
\label{sec:org3d1fa38}
Let \(B=A+^tA=(b_{ij})=(a_{ij}+a_{ji})\). Since, \(b_{ij}=a_{ij}+a_{ji}=a_{ji}+b_{ij}=b_{ji}\), \(B\) is symmetric.
\item \textbf{Exercise 11}
\label{sec:orgc9ce870}
Skip
\item \textbf{Exercise 12}
\label{sec:org035232f}
Skip
\item \textbf{Exercise 13}
\label{sec:org16594b9}
...
\end{enumerate}
\subsection{\(\S\) 3}
\label{sec:orgf58f749}
\subsubsection{Exercises}
\label{sec:org6f2e108}
\begin{enumerate}
\item \textbf{Exercise 1}
\label{sec:org55fdff5}
\(AI=IA=A\)
\item \textbf{Exercise 2}
\label{sec:org7bec908}
\(AO=O\)
\item \textbf{Exercise 3}
\label{sec:org06bd167}

For every \(A\) and \(B\), \((AB)C=A(BC)\).
\begin{enumerate}
\item Case 1
\label{sec:org7e1c8a9}
$$\begin{pmatrix}
3&2\\
4&1
\end{pmatrix}$$
\item Case 2
\label{sec:org25150f8}
$$\begin{pmatrix}
10\\
14
\end{pmatrix}$$
\item Case 3
\label{sec:orgcb3531c}
$$\begin{pmatrix}
33&37\\
11&-18
\end{pmatrix}$$
\end{enumerate}
\item \textbf{Exercise 4}
\label{sec:org1cefe3b}
This one could be proved as it is proved \hyperref[org53191b8]{here}.
\item \textbf{Exercise 5}
\label{sec:orgda9031e}
$$AB=\begin{pmatrix}
4&2\\
5&-1
\end{pmatrix}$$
...
\item \textbf{Exercise 7}
\label{sec:orgc2d9739}
$$XA=\begin{pmatrix}
3&1&5
\end{pmatrix}$$
\item \textbf{Exercise 8}
\label{sec:orgf83d6c1}
$$\begin{aligned}
X_1 A=A_2\\
X_2 A=A_3
\end{aligned}$$
...
\end{pmatrix}$$
\item \textbf{Exercise 15}
\label{sec:orgb691039}
\(AX=A^2\) (second column of \(A\)).
\item \textbf{Exercise 16}
\label{sec:org1a0b5db}
\(AX=A^i\)
\item \textbf{Exercise 17}
\label{sec:orgec248c2}
...
\label{sec:orgec634e9}
\item Set \(A^{-1}=(-A-2I)\)
\label{sec:org9c8a798}
\item Set \(A^{-1}=(-A^2-A)\)
\label{sec:org74ac2fa}
\end{enumerate}
\item \textbf{Exercise 19}
\label{sec:orgcda9599}
$$AB=\begin{pmatrix}
1 & ab\\
0 & 1
\end{pmatrix}$$
...
\item \textbf{Exercise 20}
\label{sec:org6ebbdcc}
$$A^{-1}=\begin{pmatrix}
1 & -a \\
0 & 1
\end{pmatrix}$$
\item \textbf{Exercise 21}
\label{sec:org28163f1}
...
\label{sec:org96d3999}
$$A=\begin{pmatrix}
0 & 1\\
-1 & 0
\end{pmatrix}$$
\item \textbf{Exercise 25}
\label{sec:org11ce416}
\begin{enumerate}
\item \(\text{tr}(A)=2\)
\label{sec:org82e0649}
\item \(\text{tr}(A)=4\)
\label{sec:orgb3741b0}
\item \(\text{tr}(A)=8\)
\label{sec:org79a2921}
\end{enumerate}
\item \textbf{Exercise 26}
\label{sec:org7982ed0}
See \textbf{Exercise 27}.
\item \textbf{Exercise 27}
\label{sec:org6c39592}
$$\begin{aligned}
...
\end{enumerate}
\section{Chapter 3}
\label{sec:org1cd1a7c}
\subsection{\(\S\) 1}
\label{sec:org24599ca}
\subsubsection{Notes}
\label{sec:org4c5d313}
...
\subsubsection{Exercises}
\label{sec:orgaff7856}
\begin{enumerate}
\item \textbf{Exercise 1}
\label{sec:org00d226d}
\emph{\textbf{Calculus involved, not doing now.}}
\item \textbf{Exercise 2}
\label{sec:org3ac6784}
Proved in notes.
\item \textbf{Exercise 3}
\label{sec:org8814325}
\begin{enumerate}
\item \(L(X)=11\)
\label{sec:orgc0525d0}
\item \(L(X)=13\)
\label{sec:org89e1e6f}
\item \(L(X)=6\)
\label{sec:orgf3ff93b}
\end{enumerate}
\item \textbf{Exercise 4}
\label{sec:org959c8ba}

\(F(1)=(e,1)\), \(F(0)=(1,0)\), \(F(-1)=(e^{-1},-1)\)
\item \textbf{Exercise 5}
\label{sec:org347000c}

\((F+G)(1)=(e+1,3)\), \((F+G)(2)=(e^2+2,6)\), \((F+G)(0)=(1,0)\)
\item \textbf{Exercise 6}
\label{sec:orgc9510b3}

\((2F)(0)=(2,0)\), \((\pi F)(1)=(\pi e,\pi)\)
\item \textbf{Exercise 7}
\label{sec:orgb3451b7}
For (a), it is 1. For (b), it is 11.
\item \textbf{Exercise 8}
\label{sec:org817bb11}

The image is a ellipse of the equation
$$\frac{u^2}{4}+\frac{w^2}{9}=1$$
Proof is omitted.
\item \textbf{Exercise 9}
\label{sec:orgb5e0d3b}
